...
public class AddProfilePictureActivity extends AppCompatActivity {
    ...
    String Storage_Path = "userImages";

    String Database_Path = "userImages";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new ProgressDialog(AddProfilePictureActivity.this);
    ...
    public void UploadImageFileToFirebaseStorage() {
        ...
        if (FilePathUri != null) {
            ...
            storageReference2nd.putFile(FilePathUri)
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception exception) {
                            ...
                            Toast.makeText(AddProfilePictureActivity.this, exception.getMessage(), Toast.LENGTH_LONG).show();
                        }
                    })
            ...
            Toast.makeText(AddProfilePictureActivity.this, "Please Select Image or Add Image Name", Toast.LENGTH_LONG).show();
